...
Notes and references for concepts explored in this project.

| File | Source | Key concept |
|---|---|---|
| [anthropic-evals.md](anthropic-evals.md) | Anthropic Engineering Blog | Eval anatomy, grader types, pass@k, capability vs regression |
| [hamel-evals.md](hamel-evals.md) | Hamel Husain / Substack | Why evals matter, vibe-check hell, feedback loops |
| [handbook-evals.md](handbook-evals.md) | AI Evals for Everyone (PDF) | Non-determinism, model vs product evals, terminology |
| [handbook_evals_updated.pdf](handbook_evals_updated.pdf) | — | Full handbook |
| [03-agentic-systems-anthropic.md](03-agentic-systems-anthropic.md) | Anthropic Engineering Blog | Multi-agent failure modes, orchestrator-workers, minimal footprint |
| [03-agentic-systems-fractional-ai.md](03-agentic-systems-fractional-ai.md) | Fractional AI Blog | Context bloat, agent footprint, safety-agent case study |
