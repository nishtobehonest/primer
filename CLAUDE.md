...
- Ch02: "Agents that ramble vs. agents that plan. Here's what separates them."
...
2. Add a LIVE card to the root `index.html` chapter grid — write the description in the "slop fix" voice above
3. Push to main — Vercel auto-deploys
4. Write a LinkedIn post using the template in the Content section below
